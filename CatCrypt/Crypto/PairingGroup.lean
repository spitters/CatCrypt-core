...
scoped notation:80 x " ^ᵍ " a => zpowZMod₁ x a

/-- Notation: `x ^ʰ a` for ZMod exponentiation in G₂ -/
scoped notation:80 x " ^ʰ " a => zpowZMod₂ x a
...
/-- e(x^n, y) = e(x, y)^n for any x ∈ G₁ (not just the generator) -/
