...
theorem rHoare_symm_eq {α} {c₁ c₂ : SPComp α}
    (h : rHoare eqPre c₁ c₂ eqPost) : rHoare eqPre c₂ c₁ eqPost := by
  apply rHoare_symm
  refine rHoare_conseq ?_ ?_ h
  · intro h₁ h₂ hh; exact hh.symm
  · intro a₁ h₁ a₂ h₂ hh; exact ⟨hh.1.symm, hh.2.symm⟩
